...
-- ************************************************************Agregar Productos******************************************************************
Delimiter $$
	create procedure sp_AgregarProductos (in productoId int , in nombreProducto varchar (50), in descripcionProducto varchar (100), in cantidadStock int,
    in precioVentaUnitario decimal (10,2),in precioVentaMayor decimal (10,2), in precioCompra decimal (10,2), in imagenProducto blob, in codigoProveedor int, in categoriaProductosId int) 
		Begin 
			Insert into Productos (productoId, nombreProducto, descripcionProducto, cantidadStock, precioVentaUnitario, precioVentaMayor, 
            precioCompra, imagenProducto, codigoProveedor, categoriaProductosId) values 
            (productoId, nombreProducto, descripcionProducto, cantidadStock, precioVentaUnitario, precioVentaMayor, 
            precioCompra, imagenProducto, codigoProveedor, categoriaProductosId);
            
		End $$
Delimiter ;

call sp_AgregarProductos(01, ' EcoHarvest Manzanas Gala Orgánicas', 'Estas manzanas Gala orgánicas de EcoHarvest son cultivadas con los más altos estándares de agricultura sostenible.
', 11, 13.99, 10.99, 9.99,'',2,1);
call sp_AgregarProductos(08, 'PrimeCut Filete de Res Wagyu', 'El filete de res Wagyu PrimeCut es una exquisitez culinaria para los paladares más exigentes. Proveniente de ganado Wagyu criado en condiciones óptimas, esta carne se distingue por su marmoleado único y su textura extraordinariamente tierna.
', 15, 15.99, 13.99, 12.99,'', 2,2);
